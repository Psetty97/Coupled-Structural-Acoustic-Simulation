...
# File path setup
input_file = r'D:\Work\CavityModeling\Cube\Sequentially_Coupled_3\RUN\submo_2_cleaned.dat'  # Modify this path to your actual data file location
output_folder = r'D:\Work\CavityModeling\Cube\Sequentially_Coupled_3\RUN\por_based_on_freq'  # Modify this path to where you want to save the numpy files
